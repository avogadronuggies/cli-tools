...
export function activate(context: vscode.ExtensionContext) {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("cliToolSuite.copyCommand", (cmd: string) => {
...
class TerminalHistoryProvider implements vscode.TreeDataProvider<TerminalHistoryItem> {
  private _onDidChangeTreeData: vscode.EventEmitter<TerminalHistoryItem | undefined | void> = new vscode.EventEmitter<TerminalHistoryItem | undefined | void>();
  readonly onDidChangeTreeData: vscode.Event<TerminalHistoryItem | undefined | void> = this._onDidChangeTreeData.event;
